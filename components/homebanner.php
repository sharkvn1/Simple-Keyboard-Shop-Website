<div class="banner">
    <div id="homeBanner" class="carousel slide slider carousel-fade" data-bs-ride="true">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active ">
                <img src="./img/banner/slider_2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./img/banner/slider_3.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./img/banner/slider_4.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
