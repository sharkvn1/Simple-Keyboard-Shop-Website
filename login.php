...
use function fun\login_auth;
use function fun\test_input;

?>

<body class="d-flex flex-column gap-3 justify-content-center align-items-center bg-dark ">
    <div class="loginForm bg-white ">
        <h1>Login</h1>
        <form action="" method="post" class="w-75" style="height: 240px">
            <div class="mb-2">
                <label for="username" class="form-label">Username - Email</label>
                <input type="text" class="form-control" name="log_username_mail" id="username" placeholder="Your username or Email">
            </div>
            <div class="mb-1">
                <label for="password" class="form-label">Password</label>
                <input type="password" class="form-control" name="log_password" id="log_password" placeholder="Your password">
            </div>
            <div style="color: re;">
                <?php
                if (isset($_POST['btn_login'])) {
                    ...
                    if (empty($username_mail) || empty($password)) {
                        ...
                        echo login_auth($username_mail, $password);
                    }
                }
                ?>
            </div>
